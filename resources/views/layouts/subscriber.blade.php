...
<div id="portal-wrap">
    ...
    <aside id="sidebar">
        ...
        <nav class="sb-nav">
            ...
            <a href="/cashier" class="sb-item {{ request()->is('cashier*') ? 'active' : '' }}">
                <div class="sb-icon"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg></div>
                Cashier
            </a>
